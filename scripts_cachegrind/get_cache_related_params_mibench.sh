...
BENCHMARKS=("adpcm_large_enc" "adpcm_small_dec" "basicmath_large" "basicmath_small" "bf_large_dec" "bf_small_enc" "bitcount_large" "bitcount_small" "crc32" "dijkstra_large" "dijkstra_small" "fft_large" "fft_small" "fft_small_inv" "gsm_large_dec" "gsm_large_enc" "gsm_small_dec" "gsm_small_enc" "jpeg_large_ppm" "jpeg_large_progressive" "jpeg_small_ppm" "jpeg_small_progressive" "patricia_large" "patricia_small" "qsort_large" "qsort_small" "rijndael_large_dec" "rijndael_large_enc" "rijndael_small_dec" "rijndael_small_enc" "sha_large" "sha_small" "stringsearch_large" "stringsearch_small" "susan_large" "susan_large_corner" "susan_large_edge" "susan_large_smooth" "susan_small" "susan_small_corner" "susan_small_edge" "susan_small_smooth")

cd $BENCHMARK_DIR

for benchmark_name in ${BENCHMARKS[@]}
do
    output_file=$benchmark_name"_filtered.csv"
    echo "Generating the results for the $benchmark_name"
    ...
    do
        ...
        filename_bip0015625=$(echo results_$benchmark_name\_$s\_bip0.015625.log)
        filename_bip003125=$(echo results_$benchmark_name\_$s\_bip0.03125.log)
        filename_bip00625=$(echo results_$benchmark_name\_$s\_bip0.0625.log)
