...
BENCHMARKS=("adpcm" "bs" "bsort100" "bsort" "cnt" "compress" "cover" "crc" "duff" "edn" "expint" "fac" "fdct" "fft1" "fibcall" "fir" "insertsort" "janne_complex" "jfdctint" "lcdnum" "lms" "ludcmp" "matmul" "minver" "ndes" "ns" "nsichneu" "prime" "qsort-exam" "qurt" "select" "st" "statemate" "ud")
