...
home_dir     = "/home/Bruna/valgrind_tum/cortexsuite/"
...
#benchmarks_list_cortex = [ "pca-large", "pca-medium", "pca-small", "svd3-small", "svd3-medium", "svd3-large"  ]
benchmarks_list_cortex = [ "pca-small" ]
...
def main():
    ...
    if len(sys.argv) != 3:
        print ("Specify [run|stats|get] [cortex|vision|all]")
        return 1
...
def get_all():
    ...
    for benchmark in benchmarks_list:
        stats_filename = benchmarks_dirs[benchmark] + "stats_" + benchmark + ".log"
