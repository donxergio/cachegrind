...
directory="/home/Bruna/valgrind_tum/new_results/results_pca/"
...
def l1_cache_analysis(input_file_info, cache_params):
    ...
    file.write("SIZE,LRU,BIP0.015625,BIP0.03125,BIP0.0625,DIP0.015625,DIP0.03125,DIP0.0625\n")
    for index, row in data.iterrows():
        ...
        wcet_dip0015625 = calculate_wcet(row['DIP0.015625-I'], row['DIP0.015625-D'], row['DIP0.015625-M'], cache_params)

        wcet_dip003125 = calculate_wcet(row['DIP0.03125-I'], row['DIP0.03125-D'], row['DIP0.03125-M'], cache_params)

        wcet_dip00625 = calculate_wcet(row['DIP0.0625-I'], row['DIP0.0625-D'], row['DIP0.0625-M'], cache_params)
        ...
        file.write(str(row['SIZE'])+","+str(wcet_lru)+","+str(wcet_bip0015625)+","+str(wcet_bip003125)+","+str(wcet_bip00625)+","+str(wcet_dip0015625)+","+str(wcet_dip003125)+","+str(wcet_dip00625)+"\n")
